# -*- coding: utf-8 -*-
#
# TASOC T'DA CODE documentation build configuration file, created by
...
latex_documents = [
  (master_doc, 'TASOCTDACODE.tex', u'TASOC T\'DA Code Documentation',
   u'T\'DA members', 'manual'),
]
...
texinfo_documents = [
  (master_doc, 'TASOCTDACODE', u'TASOC T\'DA Code Documentation',
   author, 'TASOCTDACODE', 'One line description of project.',
   'Miscellaneous'),
]
